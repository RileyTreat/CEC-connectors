...
function ManagePage() {
    ...
    <div>
        ...
        <Link to={`/connector/${userId}`} className="organization-tile mt-8 p-6 border-2 border-gray-300 rounded-lg hover:shadow-lg hover:border-blue-500 transition-all inline-block px-4">
            ...
            <div className="mt-4 flex gap-4">
                <button className="btn btn-primary px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700 transition-all">
                Update Form
                </button>
                <button className="btn btn-danger px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-700 transition-all">
                Delete Form
                </button>
            </div>
        </Link>
