...
const AboutPage = () => {
  return (
    ...
    <div className="absolute inset-0 bg-black bg-opacity-30"></div> {/* Slightly opaque black overlay */}
    ...
    <div className="relative z-10">
      ...
      <section className="mb-6">
        <div className="bg-blue-500 bg-opacity-80 text-white p-6 rounded-lg">
      ...
      {/* Vision Section */}
      <section className="mb-6">
        <div className="bg-green-500 bg-opacity-80 text-white p-6 rounded-lg">
