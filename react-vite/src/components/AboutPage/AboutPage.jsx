...
const AboutPage = () => {
  return (
    <div className="p-8">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold">Overview of the DOE Community Energy Connectors Program</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold">Supporting Regional Clean Energy and Economic Development</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold">The Role of Energy Connectors in Local Communities</h2>
        <p>
