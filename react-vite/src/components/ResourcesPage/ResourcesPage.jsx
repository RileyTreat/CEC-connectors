...
const ResourcesPage = () => {
  return (
    ...
    <div className="relative z-10">
      ...
      <section className="mb-8 bg-blue-500 p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold mb-4">Case Studies and Success Stories</h2>
      ...
      <section className="mb-8 bg-green-500 p-6 rounded-lg shadow-lg">
        <h2 className="text-2xl font-semibold mb-4">Other Technical Assistance Programs for Clean Energy Development</h2>
